...
/*   Updated: 2024/01/29 14:33:25 by wecorzo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int     ft_strchr_err(const char *s, int c)
{
        int     i;
...
static char	*read_stash(char *line_temp, int fd)
{
	ssize_t	b_read;
	char	*buffer;
	char	*temp;
...
static char	*return_line(char **line_temp)
{
	int		i;
	char	*line;
	char	*aux;
